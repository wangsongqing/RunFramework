 ...
 * 打地鼠模型model
  +---------------------------------------------------------------------------------------------------------------
 */
class play_hamsterModel extends modelMiddleware {

    public $tableKey = 'play_hamster'; //数据表key
     ...
     * @return array
     */
    public function get_play_hamster_top($start_time, $end_time, $order_type = 0, $limit = 10) {
